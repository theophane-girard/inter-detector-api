...
export class CoreController {
  ...
  onDeployEvent(req: Request|any, res: Response) {
    ...
    exec('git -C /opt/inter-detector-api reset --hard', this.execCallback)
    exec('git -C /opt/inter-detector-api reset --clean -df', this.execCallback)
    exec('git -C /opt/inter-detector-api reset pull -f', this.execCallback)
    exec('npm -C /opt/inter-detector-api i --production', this.execCallback)
